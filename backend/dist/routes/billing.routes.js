...
router.get("/checkout/instant", auth_middleware_1.protect, tenant_middleware_1.requireBusinessContext, (0, rbac_middleware_1.requirePermission)("billing:manage"), (0, audit_middleware_1.auditRequest)("billing.instant_checkout_requested"), billing_controller_1.BillingController.instantCheckout);
router.post("/checkout/instant", auth_middleware_1.protect, tenant_middleware_1.requireBusinessContext, (0, rbac_middleware_1.requirePermission)("billing:manage"), (0, audit_middleware_1.auditRequest)("billing.instant_checkout_requested"), billing_controller_1.BillingController.instantCheckout);
