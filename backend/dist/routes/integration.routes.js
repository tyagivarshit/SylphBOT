...
router.get("/instagram/status", auth_middleware_1.protect, (0, rbac_middleware_1.requirePermission)("settings:view"), integration_controller_1.getInstagramStatus);
router.get("/instagram/health", auth_middleware_1.protect, (0, rbac_middleware_1.requirePermission)("settings:view"), integration_controller_1.getInstagramHealth);
router.get("/instagram/history", auth_middleware_1.protect, (0, rbac_middleware_1.requirePermission)("settings:view"), integration_controller_1.getInstagramHistory);
router.post("/instagram/reconnect", auth_middleware_1.protect, (0, rbac_middleware_1.requirePermission)("settings:manage"), integration_controller_1.reconnectInstagram);
