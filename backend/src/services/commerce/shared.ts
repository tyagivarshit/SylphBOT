...
export const SUBSCRIPTION_TRANSITIONS: Record<
  ...
  SubscriptionLedgerStatus[]
> = {
  PENDING: ["TRIALING", "ACTIVE", "CANCELLED", "EXPIRED", "PAYMENT_PENDING"],
  TRIALING: ["ACTIVE", "PAST_DUE", "CANCELLED", "EXPIRED", "GRACE"],
  ACTIVE: ["PAST_DUE", "PAUSED", "CANCELLED", "EXPIRED", "SUSPENDED", "GRACE"],
  PAST_DUE: ["ACTIVE", "PAUSED", "CANCELLED", "EXPIRED", "GRACE", "SUSPENDED", "PAYMENT_PENDING"],
  PAUSED: ["ACTIVE", "CANCELLED", "EXPIRED", "SUSPENDED"],
  CANCELLED: ["REACTIVATING", "ACTIVE"],
  EXPIRED: ["REACTIVATING", "ACTIVE"],
  GRACE: ["ACTIVE", "PAST_DUE", "CANCELLED", "EXPIRED", "PAYMENT_PENDING"],
  SUSPENDED: ["ACTIVE", "CANCELLED", "EXPIRED", "REACTIVATING"],
  REACTIVATING: ["ACTIVE", "CANCELLED", "EXPIRED", "PAYMENT_PENDING"],
  PAYMENT_PENDING: ["ACTIVE", "PAST_DUE", "CANCELLED", "EXPIRED"],
};
