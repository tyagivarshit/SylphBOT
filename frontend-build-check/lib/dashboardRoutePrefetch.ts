...
const LOW_PRIORITY_PREFETCH_ROUTES = new Set([
  "/automation",
  "/comment-automation",
  "/knowledge-base",
  "/booking",
...
let dashboardRoutePrefetchPaused = false;

export const setDashboardRoutePrefetchPaused = (paused: boolean) => {
  dashboardRoutePrefetchPaused = paused;
};
...
export async function prefetchDashboardRoute(
  ...
  if (dashboardRoutePrefetchPaused && LOW_PRIORITY_PREFETCH_ROUTES.has(href)) {
    return;
  }
